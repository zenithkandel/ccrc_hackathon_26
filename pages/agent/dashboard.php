...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-6);margin-top:var(--space-6);">
    ...
    <div class="card">
        ...
        <div class="card-body" style="display:flex;flex-direction:column;gap:var(--space-3);">
            <a href="<?= BASE_URL ?>/pages/agent/add-location.php" class="btn btn-secondary"
            ...
            <a href="<?= BASE_URL ?>/pages/agent/add-vehicle.php" class="btn btn-secondary"
                style="justify-content:flex-start;gap:var(--space-3);">
                <i data-feather="truck" style="width:18px;height:18px;"></i>
                Register a Vehicle
            </a>
            <a href="<?= BASE_URL ?>/pages/agent/add-route.php" class="btn btn-secondary"
                style="justify-content:flex-start;gap:var(--space-3);">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div style="display:flex;flex-direction:column;gap:var(--space-4);" id="breakdown-chart">
                <div class="breakdown-row">
                    <div style="display:flex;align-items:center;gap:var(--space-2);">
                        <span
                            style="width:10px;height:10px;border-radius:var(--radius-full);background:var(--color-primary-500);"></span>
                ...
                <div class="breakdown-row">
                    <div style="display:flex;align-items:center;gap:var(--space-2);">
                        <span
                            style="width:10px;height:10px;border-radius:var(--radius-full);background:var(--color-accent-500);"></span>
                ...
                <div class="breakdown-row">
                    <div style="display:flex;align-items:center;gap:var(--space-2);">
                        <span
                            style="width:10px;height:10px;border-radius:var(--radius-full);background:var(--color-success-500);"></span>
            ...
            <!-- Simple bar chart -->
            <div style="display:flex;gap:var(--space-2);align-items:flex-end;height:80px;margin-top:var(--space-5);"
                id="bar-chart">
                <div class="bar-col" style="flex:1;">
                    <div class="bar" id="bar-locations"
                        style="background:var(--color-primary-500);height:0;border-radius:var(--radius-sm) var(--radius-sm) 0 0;transition:height 0.5s ease;">
                    </div>
                </div>
                <div class="bar-col" style="flex:1;">
                    <div class="bar" id="bar-vehicles"
                        style="background:var(--color-accent-500);height:0;border-radius:var(--radius-sm) var(--radius-sm) 0 0;transition:height 0.5s ease;">
                    </div>
                </div>
                <div class="bar-col" style="flex:1;">
                    <div class="bar" id="bar-routes"
                        style="background:var(--color-success-500);height:0;border-radius:var(--radius-sm) var(--radius-sm) 0 0;transition:height 0.5s ease;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card-body" style="padding:0;">
        <table class="table">
            ...
            <tbody id="recent-tbody">
                <tr>
                    <td colspan="4" class="text-center text-muted" style="padding:var(--space-8);">Loading...</td>
                </tr>
            </tbody>
        </table>
    </div>
