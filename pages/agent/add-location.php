...
<div style="display:grid;grid-template-columns:1fr 380px;gap:var(--space-6);">
    ...
    <div class="card">
        ...
        <div class="card-body" style="padding:0;">
            <div id="location-map" class="data-collection-map" style="height:480px;border-radius:0 0 var(--radius-lg) var(--radius-lg);"></div>
        </div>
    </div>
            ...
            <div class="card-body">
                <form id="location-form">
                    <div class="form-group">
                        <label class="form-label" for="loc-name">Name <span style="color:var(--color-danger-500);">*</span></label>
                        <input type="text" id="loc-name" class="form-input" placeholder="e.g. Kalanki Chowk" required>
                    </div>

                    <div class="form-group" style="margin-top:var(--space-4);">
                        <label class="form-label" for="loc-type">Type <span style="color:var(--color-danger-500);">*</span></label>
                    ...
                    <div class="form-group" style="margin-top:var(--space-4);">
                        ...
                        <textarea id="loc-desc" class="form-input" rows="2" placeholder="Optional description or landmark details"></textarea>
                    </div>

                    <div class="form-group" style="margin-top:var(--space-4);">
                        <label class="form-label" for="loc-notes">Notes for Reviewer</label>
                        <textarea id="loc-notes" class="form-input" rows="2" placeholder="Any additional context for the admin reviewer"></textarea>
                    </div>
