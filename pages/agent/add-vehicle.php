        ...
        <div class="card-body">
            <form id="vehicle-form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="form-label" for="veh-name">Vehicle / Service Name <span style="color:var(--color-danger-500);">*</span></label>
                ...
                <div class="form-group" style="margin-top:var(--space-4);">
                    ...
                    <textarea id="veh-desc" class="form-input" rows="3" placeholder="Vehicle details, capacity, color, route info, etc."></textarea>
                </div>

                <!-- Image Upload -->
                <div class="form-group" style="margin-top:var(--space-4);">
                    <label class="form-label">Vehicle Photo</label>
                    <div id="image-dropzone" style="border:2px dashed var(--color-neutral-200);border-radius:var(--radius-lg);padding:var(--space-6);text-align:center;cursor:pointer;transition:border-color var(--transition-fast);">
                        <i data-feather="camera" style="width:32px;height:32px;color:var(--color-neutral-300);margin-bottom:var(--space-2);"></i>
                        <p style="font-size:var(--text-sm);color:var(--color-neutral-500);margin:0;">Click to upload or drag and drop</p>
                        <p style="font-size:var(--text-xs);color:var(--color-neutral-400);margin:var(--space-1) 0 0;">JPG, PNG, or WebP — max 2 MB</p>
                        <img id="image-preview" style="display:none;max-width:200px;max-height:150px;margin:var(--space-3) auto 0;border-radius:var(--radius-md);" alt="Preview">
                    </div>
                ...
                <div class="form-group" style="margin-top:var(--space-4);">
                    <label style="display:flex;align-items:center;gap:var(--space-3);cursor:pointer;">
                        <input type="checkbox" id="veh-electric" style="width:18px;height:18px;accent-color:var(--color-primary-600);">
                        <span>
                            <span class="form-label" style="margin:0;display:block;">Electric Vehicle</span>
                            <span style="font-size:var(--text-xs);color:var(--color-neutral-400);">Check if this is an electric/EV vehicle</span>
                        </span>
                    </label>
                </div>
                ...
                <div class="form-group" style="margin-top:var(--space-4);">
                    ...
                    <textarea id="veh-notes" class="form-input" rows="2" placeholder="Any additional context"></textarea>
                </div>
