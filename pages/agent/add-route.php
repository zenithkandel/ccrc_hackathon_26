...
<div style="display:grid;grid-template-columns:1fr 380px;gap:var(--space-6);">
    ...
    <div class="card">
        ...
        <div class="card-body" style="padding:0;">
            <div id="route-map" class="data-collection-map"
                style="height:520px;border-radius:0 0 var(--radius-lg) var(--radius-lg);"></div>
        </div>
    </div>
                ...
                <form id="route-form">
                    ...
                    <div
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="route-fare-base" class="form-input" placeholder="e.g. 20"
                                step="0.01" min="0">
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="route-fare-km">Fare/km (NPR)</label>
                            <input type="number" id="route-fare-km" class="form-input" placeholder="e.g. 2.50"
                                step="0.01" min="0">
                        </div>
                    </div>
                    ...
                    <!-- Search & Add Stops -->
                    <div class="form-group"
                        style="margin-top:var(--space-5);border-top:1px solid var(--color-neutral-100);padding-top:var(--space-5);">
                        <label class="form-label">Add Stops (in order) <span
                                style="color:var(--color-danger-500);">*</span></label>
                        <div style="position:relative;">
                            <input type="text" id="stop-search" class="form-input"
                                placeholder="Search approved locations..." autocomplete="off">
                            <div id="stop-results"
                                style="display:none;position:absolute;top:100%;left:0;right:0;z-index:10;background:var(--color-white);border:1px solid var(--color-neutral-200);border-top:none;border-radius:0 0 var(--radius-md) var(--radius-md);max-height:200px;overflow-y:auto;box-shadow:var(--shadow-md);">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="stop-list" class="route-builder-list" style="margin-top:var(--space-3);min-height:60px;">
                        <div class="empty-state" style="padding:var(--space-6) 0;text-align:center;">
                            <p style="font-size:var(--text-sm);color:var(--color-neutral-400);margin:0;">Search and add
                                at least 2 stops to build a route.</p>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top:var(--space-4);">
                        ...
                        <textarea id="route-notes" class="form-input" rows="2"
